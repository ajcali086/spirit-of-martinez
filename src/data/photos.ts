...
export const photos: Record<PhotoId, ArchivePhoto> = {
  ...
  pregnant: {
    ...
    width: 1121,
    height: 1500,
    alt: "Joyce Calicura in a green dress sitting on the bumper of a maroon car at a cabin court",
    caption:
      "Joyce, 1943. After Maxwell, before the boy. Kodachrome, a maroon car, a cabin court. She is already carrying Frank James Calicura Jr.",
    credit: "Family collection",
    kind: "photograph",
  },
  cockpit: {
    ...
    caption:
      "Left seat, right seat. Frank Calicura and Victor Probst in a B-17 cockpit. The collection does not date the plate, or name the field.",
    credit: "Family collection",
    kind: "photograph",
  },
  calicura: {
    ...
    caption:
      "Frank Calicura, left-hand seat. Cropped from a cockpit plate with Victor Probst in the other. Garrison cap, leather, the panel between them.",
    credit: "Family collection",
    kind: "photograph",
  },
  probst: {
    ...
    caption:
      "Victor G. Probst, right-hand seat. The copilot. Cropped from the same plate. He is the man who spent the first morning in The Red Fox.",
    credit: "Family collection",
    kind: "photograph",
  },
  signatures: {
