...
export const photos: Record<PhotoId, ArchivePhoto> = {
  ...
  probst: {
    ...
    caption:
      "Avon Park. Victor G. Probst, right-hand seat. The copilot. Cropped from the same plate. He is the man who spent the first morning in The Red Fox.",
    credit: "Family collection",
    kind: "photograph",
  },
  signatures: {
  ...
  noses: {
    ...
    caption:
      "A later montage of nose art, not a photograph of the hardstand. Spirit of Martinez sits lower right. Belligerent Beauty is on the same sheet, upper right — the ship of April 7. Fire Ball Red and Paisano are details from this page.",
    credit: "Family collection",
    kind: "photograph",
  },
  fireball: {
  ...
  paisano: {
    ...
    caption:
      "Paisano. A detail from the montage. A 335th Squadron ship — the one that stalled in Aunt Callie’s Baby’s wash on March 2. Not a ship this crew borrowed.",
    credit: "Family collection",
    kind: "photograph",
  },
  spiritart: {
