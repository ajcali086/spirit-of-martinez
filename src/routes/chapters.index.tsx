  ...
  return (
    <SiteShell>
      <PageHero
        ...
        dek="Read in order, or open any chapter the way a family opens a box — wherever the hand lands. The first four have a reading. It will keep playing while you move through the book."
